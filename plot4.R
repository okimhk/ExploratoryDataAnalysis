...
#Plot 1
with(powerDT, plot(dateTime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))

#Plot 2
with(powerDT, plot(dateTime, Voltage, type="l", ylab="Voltage"))
...
#Plot 4
with(powerDT, plot(dateTime, Global_reactive_power, type="l", ylab="Global_reactive_power"))
